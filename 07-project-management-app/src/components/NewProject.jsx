...
export default function NewProject({ onAdd, onCancel }) {
  ...
  function handleSave() {
    ...
    if (
      ...
      modal.current.open()
      return; //Este return para que no se ejecute el onAdd si entramos en esta condición de invalidez
    }
  ...
  return (
    <>
      <Modal ref={modal} buttonCaption="Okay">
        ...
        <p className='mb-4 text-stone-600'>Looks like you forgot to enter a value.</p>
